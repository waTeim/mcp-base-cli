...
class GenericOIDCSetup:
    ...
    def setup(
        ...
        self.generate_helm_values(
            ...
            test_sidecar_enabled=test_sidecar_enabled,
        )
...
"""
        ...
        # Image fields default to placeholder; mcp-project.build overrides.
        effective_image_repository = image_repository or "your-registry.example.com/mcp-server"
        effective_image_tag = image_tag if image_tag is not None else ""

        # service.type / testSidecar — mcp-project.deployment overrides chart defaults.
...
image:
  repository: {effective_image_repository}
  pullPolicy: Always
  tag: "{effective_image_tag}"  # Leave empty to use Chart.AppVersion
